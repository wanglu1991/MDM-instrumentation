...
class interval(object):
    ...
    def reset_MSHR(self,MSHR_size):
        self.numMshrs=MSHR_size
        self.queuing_delay_mshr_optimal=[]
        self.queuing_delay_mshr_optimal_new=[]
        self.queuing_delay_dram=[]
        self.queuing_delay_noc=[]
...
#def multi_RR(nonoverlap_insts,warp_numbers):
    def IPC_full(self):
        ...
        print(GPUMech_ipc)
        result=open('GPUMech_baseline_'+str(self.numMshrs),'a')
        ...
        print(self.total_instruction_counts)
        result=open('result_delay_model+optimal_MSHR_'+str(self.numMshrs),'a')
        result.write(str(Our_model_ipc)+','+str(self.total_instruction_counts)+'\n')
        MPL_result=open('MPL','a')
        MPL_result.write(str(self.MPL)+'\n')
        delay_result=open('result_delay_model_'+str(self.numMshrs),'a')
        ...
        new_MSHR_result=open('result_delay_model+ceiling_MSHR_'+str(self.numMshrs),'a')
...
def main(kernel_id):
   ...
   # intervalInstance.contention_DRAM_modeling()
    ...
    for i in range(0,1):
        ...
        intervalInstance.reset_MSHR(MSHR_size)
