...
#if defined(__CUDA_API_VERSION_INTERNAL) || __CUDA_API_VERSION >= 10020
    #define cuDevicePrimaryCtxRelease           cuDevicePrimaryCtxRelease_v2
    #define cuDevicePrimaryCtxReset             cuDevicePrimaryCtxReset_v2
    #define cuDevicePrimaryCtxSetFlags          cuDevicePrimaryCtxSetFlags_v2
#endif /* __CUDA_API_VERSION_INTERNAL || __CUDA_API_VERSION >= 10020 */
...
* handle, this API will error as CUDA_ERROR_NOT_SUPPORTED. There is no guarantee that
* the contents of \p handle will be the same CUDA memory handle for the same
* given OS shareable handle, or the same underlying allocation.
*
...
/**
 * CUDA API made obsolete at API version 3020
 */
#if defined(__CUDA_API_VERSION_INTERNAL)
